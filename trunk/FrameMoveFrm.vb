...
Public Class FrameMoveFrm

    Private Sub MoveButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MoveButton.Click
        VideoWindowFrm.FrameI = FrameNumericUpDown.Value
        VideoWindowFrm.GET_IMAGE(VideoWindowFrm.FrameI)
    End Sub
        ...
        Try
            ...
            Do While XTR.Read
                ...
                If Environment.OSVersion.Version.Major < 6 Then 'NT 5.X 이하
                    FrameMovePanel.Font = New Font(FNXP, FS)
                Else
                    FrameMovePanel.Font = New Font(FN, FS)
                End If

                If XTR.Name = "FrameMoveFrm" Then Me.Text = XTR.ReadString
                If XTR.Name = "FrameMoveFrmMoveButton" Then MoveButton.Text = XTR.ReadString
