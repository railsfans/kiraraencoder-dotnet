...
Imports FFmpegVB.FFmpeg.Libavformat

Namespace FFmpeg

    Partial Public Class Libavutil

        Public Const AVUTIL_DLL_NAME As String = "avutil-49.dll"
        ...
        Public Delegate Function ItemNameCallback() As [String]

        <StructLayout(LayoutKind.Sequential)> _
        Public Structure AVClass
            <MarshalAs(UnmanagedType.LPStr)> _
            Private class_name As [String]
            Private item_name As ItemNameCallback
            Private pAVOption As IntPtr
        End Structure

        <StructLayout(LayoutKind.Sequential)> _
        Public Structure AVRational
