...
#End Region
    ...
    Public Sub IDSTR(ByVal IN_PATHV As String, ByVal OUT_PATHV As String, ByVal PriorityInt As Integer, ByVal VideoOnly As Boolean, ByVal index As Integer, ByVal MATROSKAERR As Integer)
        ...
        If VideoOnly = False Then
            MSGB = FunctionCls.AppInfoDirectoryPath & "\tools\ffms\ffmsindex.exe" & " -f -t -1 -s 3 -d 0 " & "-m " & DEMUXER & " " & Chr(34) & IN_PATHV & Chr(34) & " " & Chr(34) & OUT_PATHV & Chr(34)
        Else '비디오 부분만 인덱스//
            MSGB = FunctionCls.AppInfoDirectoryPath & "\tools\ffms\ffmsindex.exe" & " -f -t 0 -s 3 -d 0 " & "-m " & DEMUXER & " " & Chr(34) & IN_PATHV & Chr(34) & " " & Chr(34) & OUT_PATHV & Chr(34)
        End If
